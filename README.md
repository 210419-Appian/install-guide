...
**NOTE**: This guide primarily is written for those on a Windows Machine. For Mac users [this guide](https://github.com/210419-Appian/mac-install-guide) may be more helpful. 
